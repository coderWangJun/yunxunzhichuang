...
//  static const int GATEWAY_TIMEOUT = 504;
  ...
  ///未知错误
  static const int UNKNOWN = 504;

  ///解析错误
  static const String PARSE_ERROR = "PARSE_ERROR";

  ///网络错误
  static const int NETWORK_ERROR = 504;

  ///协议错误
  static const int HTTP_ERROR = 415;

  ///证书错误
  static const int SSL_ERROR = 406;

...
class MyComputingPage extends StatefulWidget {
  @override
  _MyComputingPageState createState() => _MyComputingPageState();
}
class _MyComputingPageState extends State<MyComputingPage>{
                  ...
                  child: Stack(
                    children: <Widget>[
                      ...
                      Positioned(
                        left: 274.w,
                        top: 98.h,
                        child: CustomText('我的算力',fontSize: 36,color: Styles.colorWhite,),
                      ),
                    ],
                  ),
                ),

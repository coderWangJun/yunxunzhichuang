...
class ScratcherState extends State<Scratcher> {
      ...
      builder: (BuildContext context, AsyncSnapshot<ui.Image> snapshot) {
        if (snapshot.connectionState != ConnectionState.waiting) {
          ...
          return GestureDetector(
            ...
            onPanStart: widget.canScratch
                ? (details) {
              _addPoint(details.globalPosition);
            }
                : null,
            onPanUpdate: widget.canScratch
                ? (details) {
              _addPoint(details.globalPosition);
            }
                : null,
            onPanEnd: widget.canScratch
                ? (details) => setState(() {
              points.add(null);
            })
                : null,
        ...
        return Container(child: Text("afasdf",style: TextStyle(
  ...
  void reset({Duration duration}) {
    setState(() {
      ...
      isFinished = false;
      //widget.canScratch = duration == null ? true : false;
